...
CTensor* create_tensor_py(float* data, const std::size_t data_num_elems, const std::size_t* shape,
...
void get_tensor_shape_py(CTensor* tensor, std::size_t* out_shape, std::size_t* out_ndim);

void get_add_operation_result(CTensor* t1, CTensor* t2, float* out_data,
                              std::size_t* out_num_elems);

void get_sum_operation_result(CTensor* operand, const std::size_t axis, const bool keep_dims,
                              float* out_data, std::size_t* out_num_elems);

void get_matmul_operation_result(CTensor* t1, CTensor* t2, float* out_data,
                                 std::size_t* out_num_elems, std::size_t* out_n_dim);
}

CTensor* create_tensor_py(float* data, const std::size_t data_num_elems, const std::size_t* shape,
                          const std::size_t ndim) {
    CTensor* out = (CTensor*)std::malloc(sizeof(CTensor));
